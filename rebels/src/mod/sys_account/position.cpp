...
Position::Position(std::string instrument_id, double init_price,
                   std::int64_t init_quantity, PositionDirection position_direction):
...
std::int64_t Position::quantity(){
    return __old_quantity + __today_quantity;
}
...
double Position::apply_trade(const Trade& trade){
    ...
    if (trade.position_effect() == PositionEffect::OPEN){
        ...
        std::cout << "__avg_price " << __avg_price << std::endl;
...
void Position::update_last_price(double price){
    __last_price = price;
}
...
//--------------------
std::string Position::instrument_id(){
    return __instrument_id;
}
//double price;
//std::int64_t quantity;
double Position::avg_price(){
    return __avg_price;
}
double Position::trade_cost(){
    return __trade_cost;
}
double Position::transaction_cost(){
    return __transaction_cost;
}
double Position::prev_close(){
    return __prev_close;
}
...
PositionDirection Position::position_direction(){
    return __position_direction;
}
int Position::direction_factor(){
    return __direction_factor;
}