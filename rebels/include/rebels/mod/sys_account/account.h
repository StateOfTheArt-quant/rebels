...
private:
    ...
    using PositionMapMap
        = std::map<std::string, std::map<PositionDirection, std::unique_ptr<Position>>>;
...
private:
    Position* __get_or_create_position(std::string instrument_id,
                                       PositionDirection position_direction,
                                       std::int64_t init_quantity = 0,
                                       double init_price          = 0.0);
...
public:
    ...
    // just to test
    Position* get_or_create_position(std::string instrument_id,
                                     PositionDirection position_direction,
                                     std::int64_t init_quantity = 0,
                                     double init_price          = 0.0);
